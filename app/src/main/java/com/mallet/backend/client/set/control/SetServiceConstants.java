package com.mallet.backend.client.set.control;

class SetServiceConstants {
    ...
    static final String PREDEFINED_PARAM = "predefined";
    static final String SET_PATH = "set";
    static final String SET_BASIC_PATH = SET_PATH + "/basic";
