...
import com.example.mallet.frontend.model.flashcard.AdapterFlashcardStack;
import com.example.mallet.frontend.model.flashcard.CallbackFlashcardStack;
...
public class FragmentFlashcards extends Fragment {
    ...
    private void flashcardsOptionsDialog() {
        Dialog dialog = ViewUtils.createDialog(requireContext(), R.layout.dialog_flashcard_options, new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT), Gravity.BOTTOM);
    ...
    private void performSwipe(Direction direction) {
        ...
        if (currentPosition >= 0 && currentPosition < adapterFlashcardStack.getItemCount()) {
            ...
            ViewUtils.showToast(requireContext(), "No more cards to swipe");
        }
    }
    ...
    private void flashcardsFinishedDialog() {
        Dialog dialog = ViewUtils.createDialog(requireContext(), R.layout.dialog_flashcards_finished, new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT), Gravity.BOTTOM);
